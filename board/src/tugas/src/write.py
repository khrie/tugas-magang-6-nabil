...
def main():
    rospy.init_node('hand_writer', anonymous=True)
    pub = rospy.Publisher('/hand_point', Point, queue_size=10)
    ...
    while not rospy.is_shutdown():
        ...
        if len(lmlist) != 0:
            ...
            if y1 < y2:
                ...
                msg.z = 0.0
                pub.publish(msg)
                rospy.loginfo_throttle(1, f"Drawing point published: ({x1}, {y1})")
            else:
                prev_x, prev_y = 0, 0  
